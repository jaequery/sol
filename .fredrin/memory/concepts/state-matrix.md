...
| 21b | **Frame reshaped** | The **aspect ratio** select in the preview's panel head — 16:9 (default), 9:16, 1:1, 4:5, 4:3, 3:2, 21:9 | The preview frame changes shape on the spot, scaling down to whichever of the stage's dimensions gives out first; the media inside it re-fits — a photo fills and is cropped, a video fits and is letterboxed, exactly as the export writes each. The export follows (short edge 1080: 9:16 is 1080 × 1920), and so do the anchor stills an AI transition is generated from (short edge 720). Saved with the project; a project written before the setting existed opens at 16:9 | Pick another ratio |
